...
const Achievements = () => {
  const achievements = [
    ...
    },
    {
      ...
      event: "OLabs",
      date: "February 2025",
      description: "1st place for developing a smart traffic management system using IoT sensors and machine learning algorithms.",
      image: "IMG_0727.jpg",
    ...
    },
    {
      ...
      event: "VIT Bhimavaram Nstional Hackathons",
      date: "March 2025",
